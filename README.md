# Домашняя работа по семинарам Python
...
**_Урок 3. Данные, функции и модули в Python_**
...
**_Урок 5. Ускоренная обработка данных: lambda, filter, map, zip, enumerate, list comprehension_**
