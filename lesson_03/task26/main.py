...
# Решение задачи реализовано через вычисление числа Фибоначчи через возведение матрицы в степень
...
for i in range(-n, n + 1):
    # возводим в степень n матрицу 1
    matrix2 = np.linalg.matrix_power(matrix1, i)
    result.append(round(matrix2[0, 1]))
